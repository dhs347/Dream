...
struct L_B{
	V base[_M+5][_M+5],a[_M+5],b[_M+5],t; int D,cnt,Hash_Cnt=2; ll PP[]={13331,100007};
	...
	inline V* Get_Hash_Code() const {
		V ans[5]; rep(i,0,Hash_Cnt-1) ans[i]=D^cnt%_p;
...
int m,d,k,id=0; L_B<> B; ll a[15]; map <pair<ll,ll>,int> M; pair<ll,ll> ret;
