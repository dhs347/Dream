...
注：经典问题，问哪些边是最小割的可行边/必选边；对残量网络强连通缩点，满流边中，可行边连接不同强连通分量，必选边连接$S$和$T$分别所在的强连通分量
...
4.http://www.lydsy.com/JudgeOnline/problem.php?id=2229

5.https://www.lydsy.com/JudgeOnline/problem.php?id=4435
